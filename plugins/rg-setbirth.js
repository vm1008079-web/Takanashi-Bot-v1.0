...
if (!birth) {
return conn.reply(m.chat, `${emoji2} Recuerda elegir una fecha de nacimiento válida.\n> Ejemplo: ${usedPrefix + command} 01/12/2024`, m, rcanal);
}

user.birth = birth;
return conn.reply(m.chat, `${emoji} Se ha establecido tu fecha de nacimiento como: *${user.birth}*!`, m, rcanal);
};
